      ...
      {#if visiblePlatforms.length > 0}
          {#each visiblePlatforms as platform (platform)}
              ...
              <div class="w-11 h-[47px] flex-col justify-center items-center gap-2.5 inline-flex group ml-3 8k:ml-[290px] 8k:mb-[490px] 4k:ml-[110px] 4k:mb-[130px] sm:mb-[-3.2%] group sm:ml-[-1%] sm:mr-[-1%] md:ml-[1%] md:mr-[-1.3%] xl:ml-[1%] xl:mr-[-0.7%] 2k:ml-[1%] 2k:mr-[-0.2%] 4k:mr-[-0.2%] 8k:mr-[-0.6%] lg:mb-0 2k:mb-[-0.5%]">
                  <div class="w-[47px] h-[47px] 8k:w-[230px] 8k:h-[230px] 4k:w-[110px] 4k:h-[110px] 2k:w-[47px] 2k:h-[47px] xl:w-[40px] xl:h-[40px] md:w-[30px] md:h-[30px] sm:w-[25px] sm:h-[25px] xl:mb-[10px] md:mb-[20px] sm:mb-[25px] relative group flex flex-col items-center first-letter" >
                    
                      <img class="w-full h-full object-fill animated-image" src={`src/img/Platforms/${platform}.svg`} alt={platform}  />
          ...
          {/each}
          <div role="button" tabindex="0" class="w-11 h-[47px] flex-col justify-start items-center gap-2.5 inline-flex group ml-3 8k:ml-[290px] 4k:ml-[110px] sm:mb-[-3.3%] sm:ml-[-1.3%] md:ml-[0.2%] lg:mb-[-0.2%] lg:ml-[0.5%] xl:mb-[-0.2] xl:ml-[0.5%] 2k:mb-[-0.2%] 4k:mb-[5.5%] 8k:mb-[9%]"
              ...
              <div class="w-[47px] h-[47px] 8k:w-[230px] 8k:h-[230px] 4k:w-[110px] 4k:h-[110px] 2k:w-[47px] 2k:h-[47px] xl:w-[40px] xl:h-[40px] md:w-[30px] md:h-[30px] sm:w-[25px] sm:h-[25px] relative group">
                  <img class="w-full h-full animated-image" src={`src/img/Arrows/Back.svg`} alt="Arrow Back"  />
