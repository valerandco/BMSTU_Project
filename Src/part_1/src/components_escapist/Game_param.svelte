...
{#if isVisible}
  ...
  <button class="hover:bg-like_hover ml-2 text-white font-bold py-2 px-3.5 mb-5 border border-white rounded-md transition duration-300 ease-in-out whitespace-nowrap">
  ...
  <button class=" hover:bg-like_hover ml-2 text-white font-bold py-2 px-16 mb-5 border border-white rounded-md transition duration-300 ease-in-out whitespace-nowrap">
