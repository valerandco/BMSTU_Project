<script>
  ...
  let carouselItems = [
    { 
      ...
      logo: { image: "src/img/Logo/DIABLO_LOGO_520x300 1.png", position: { top: '14%', left: '4%', classPos: 'sm:top-[12%] sm:left-[5%] md:top-[10%] md:left-[4%] lg:top-[15%] lg:left-[4%] 2k:top-[11%] 2k:left-[4%] '}, sizeClasses: "8k:w-[1124px] 8k:h-[650px] 4k:w-[624px] 4k:h-[370px] 2k:w-[325px] 2k:h-[188px] xl:w-[222px] xl:h-[128px] lg:w-[171.05px] lg:h-[98.95px] md:w-[136px] md:h-[79px] sm:w-[102px] sm:h-[59px]  xsm:w-[87px] xsm:h-[50px]" },
      platforms: [
        { main: "PS", additional: [] },
    ...
    { 
      ...
      logo: { image: "src/img/Logo/Warcraft 1 logo 1.png", 
      position: {  classPos: 'sm:top-[5%] sm:left-[33%] md:top-[8%] md:left-[38%]  lg:top-[8%] lg:left-[36%] xl:top-[4%] xl:left-[38%] 2k:top-[4%] 2k:left-[38%] 4k:top-[4%] 4k:left-[36%] 8k:top-[6%] 8k:left-[36%]' }, sizeClasses: "8k:w-[2224px] 8k:h-[890px] 4k:w-[1224px] 4k:h-[510px] 2k:w-[554px] 2k:h-[250px] xl:w-[390px] xl:h-[173px] lg:w-[290px] lg:h-[133px] sm:w-[202px] sm:h-[99px] xsm:w-[97px] xsm:h-[40px] " },
      platforms: [
    ...
    { 
      ...
      logo: { image: "src/img/Logo/Overwatch-Logo 1.png", position: { top: '11%', left: '5.3%', classPos: 'sm:top-[12%] sm:left-[5%] md:top-[10%] md:left-[5%] lg:top-[9%] lg:left-[5%] ' }, sizeClasses: "8k:w-[1124px] 8k:h-[650px] 4k:w-[624px] 4k:h-[370px] 2k:w-[350px] 2k:h-[170px] xl:w-[222px] xl:h-[128px] lg:w-[171.05px] lg:h-[98.95px] md:w-[136px] md:h-[79px] sm:w-[97px] sm:h-[57px] xsm:w-[67px] xsm:h-[37px]" },
      platforms: [
    ...
    { 
      ...
      logo: { image: "src/img/Logo/HoMM-3-Logo 1.png", position: { top: '8%', left: '60%', classPos: 'sm:top-[8%] sm:left-[60%] md:top-[12%] md:left-[60%] lg:top-[8%] lg:left-[60%] 2k:top-[5%] 2k:left-[62%] 4k:top-[5%] 4k:left-[60%]  '  }, sizeClasses: "8k:w-[1700px] 8k:h-[980px] 4k:w-[932px] 4k:h-[550px] 2k:w-[454px] 2k:h-[280px] xl:w-[322px] xl:h-[188px] lg:w-[251.05px] lg:h-[148.95px] md:w-[156px] md:h-[97px] sm:w-[140px] sm:h-[87px] xsm:w-[67px] xsm:h-[37px]" },  
      platforms: [
    ...
    { 
      ...
      logo: { image: "src/img/Logo/Warhammer-40k-logo 1.png", position: { top: '5%', left: '4%', classPos: 'sm:top-[5%] sm:left-[4%] md:top-[9%] md:left-[4%] lg:top-[5%] lg:left-[4%] xl:top-[5%] xl:left-[4%] ' }, sizeClasses: "8k:w-[1900px] 8k:h-[1220px] 4k:w-[1024px] 4k:h-[630px] 2k:w-[474px] 2k:h-[310px] xl:w-[318px] xl:h-[218px] lg:w-[251.05px] lg:h-[178px] md:w-[186px] md:h-[129px] sm:w-[160px] sm:h-[117px] xsm:w-[87px] xsm:h-[57px] " },
      platforms: [
        { main: "Windows", additional: ["Battle.net", "Epic Games Store", "gog.com","Steam","Humble Bundle"] },
      ],  
    },
    { 
      ...
      logo: { image: "src/img/Logo/Cyberpunk-2077-logo 2.png", position: { top: '28%', left: '65%', classPos: 'sm:top-[28%] sm:left-[70%] md:top-[28%] md:left-[68%] lg:top-[28%] lg:left-[70%] xl:top-[28%] xl:left-[65%] ' }, sizeClasses: "8k:w-[2020px] 8k:h-[1080px] 4k:w-[1124px] 4k:h-[550px] 2k:w-[524px] 2k:h-[250px] xl:w-[322px] xl:h-[188px] lg:w-[266px] lg:h-[138px] md:w-[216px] md:h-[89px] sm:w-[177px] sm:h-[87px] xsm:w-[97px] xsm:h-[57px]" },
      platforms: [
        { main: "PS", additional: [] },
        { main: "Xbox", additional: [] },
        { main: "Windows", additional: ["Battle.net", "Epic Games Store", "gog.com","Steam","Humble Bundle"] },
